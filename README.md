...
## Gestion de projet
- [X] [Collecte des données météo](notebooks/ipynb/task-0 data-acquisition-and-cleaning) ([JIRA](https://jiraprd03.solutions.hydroquebec.com/browse/DEBIEHH-95))
- [ ] [Classification des tempêtes](notebooks/ipynb/task-1 storm-typing) (**en cours**) ([JIRA](https://jiraprd03.solutions.hydroquebec.com/browse/DEBIEHH-150))
